...
public final class ChampionsEntitySubPredicates {
  private static final DeferredRegister<MapCodec<? extends EntitySubPredicate>> DEFERRED_REGISTER = DeferredRegister.create(Registries.ENTITY_SUB_PREDICATE_TYPE, ChampionsMod.MOD_ID);
