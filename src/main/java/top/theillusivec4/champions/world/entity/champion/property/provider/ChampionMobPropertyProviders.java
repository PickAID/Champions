...
public final class ChampionMobPropertyProviders {
  private static final DeferredRegister<MapCodec<? extends ChampionMobPropertyProvider>> DEFERRED_REGISTER = DeferredRegister.create(ChampionsRegistries.CHAMPION_PROPERTY_PROVIDER_TYPE, ChampionsMod.MOD_ID);
