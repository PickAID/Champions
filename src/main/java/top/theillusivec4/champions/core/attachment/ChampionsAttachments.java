...
public final class ChampionsAttachments {
	...
	public static final Supplier<AttachmentType<ChampionProperty>> CHAMPION_MOB_PROPERTY = register("champion_mob_property", ChampionProperty.EMPTY, builder -> builder.serialize(ChampionProperty.MAP_CODEC).sync(ChampionProperty.STREAM_CODEC));
	public static final Supplier<AttachmentType<Boolean>> CHAMPION_EGG_SPAWNED = register("champion_egg_spawned", false, builder -> builder.serialize(Codec.BOOL.fieldOf("champion_egg_spawned")));
