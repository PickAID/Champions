...
public interface DifficultyBasedValue {
  Codec<DifficultyBasedValue> CODEC = Codec.lazyInitialized(() -> {
    Codec<DifficultyBasedValue> dispatchCodec = ChampionsBuiltInRegistries.DIFFICULTY_BASED_VALUE.byNameCodec().dispatch(DifficultyBasedValue::codec, Function.identity());
