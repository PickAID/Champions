...
import top.theillusivec4.champions.api.affix.effect.entity.ApplyMobEffect;
...
public final class AffixLocationBasedEffectTypes {
  ...
  private AffixLocationBasedEffectTypes() {
  }
}
