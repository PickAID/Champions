...
public final class ChampionsAttachments {
  ...
  public static final Supplier<AttachmentType<Reference2ObjectArrayMap<Affix, ObjectArraySet<AffixLocationBasedEffect>>>> ACTIVE_LOCATION_DEPENDENTS_EFFECTS = register("active_affix_location_based_effects", new Reference2ObjectArrayMap<>(), builder -> builder);
