...
public final class ChampionEggHelper {
  ...
  public static void applyEntityConfig(ItemStack stack, Entity entity) {
    ...
    ChampionProperty property = ChampionPropertyHelper.get(stack);
    boolean flag = false;
  ...
  public static void modifyItem(ItemStack stack, ChampionProperty property, EntityAffixes affixes) {
    ChampionPropertyHelper.set(stack, property);
