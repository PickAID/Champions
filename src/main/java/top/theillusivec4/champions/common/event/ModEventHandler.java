...
public class ModEventHandler {
    ...
    public void onCommonSetup(final FMLCommonSetupEvent evt) {
        evt.enqueueWork(() -> {
            ...
            Registry.register(Registry.LOOT_CONDITION_TYPE, Utils.getLocation("entity_champion"), EntityIsChampion.type);
            Registry.register(Registry.LOOT_CONDITION_TYPE, Utils.getLocation("champion_properties"), LootItemChampionPropertyCondition.INSTANCE);
    ...
    @SubscribeEvent
    public void config(final ModConfigEvent evt) {
    ...
    public void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        if (ModList.get().isLoaded("theoneprobe")) {
            ...
            InterModComms.sendTo(Champions.MODID, "theoneprobe", "getTheOneProbe",
...
//    generator.addProvider(event.includeServer(), new ModGlobalLootModifierProvider(generator));
        ...
        generator.addProvider(event.includeServer(), new GatewaysConfigProvider(generator));
