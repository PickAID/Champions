package top.theillusivec4.champions.deprecated.server.command.argument;
...
import top.theillusivec4.champions.deprecated.server.command.argument.AffixArgumentType.IAffixProvider;
