...
- Changed Reflective affix's reflected damageAmount to list the championState as the source rather than the player to avoid recursive [#133](https://github.com/TheIllusiveC4/Champions/issues/133)
player effects
### Fixed
...
### Fixed
- Fixed Global Loot Modifiers running twice when generating championState loot [#125](https://github.com/TheIllusiveC4/Champions/issues/125)
...
### Fixed
- Fixed `champions:champion_properties` loot condition potentially applying to non-championState entities
...
### Added
- Added "Champion Hunter" advancement for killing any championState mob
...
### Fixed
- Fixed converted entities losing their championState abilities [#113](https://github.com/TheIllusiveC4/Champions/issues/113)
