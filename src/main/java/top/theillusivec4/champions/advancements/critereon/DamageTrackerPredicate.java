...
public record DamageTrackerPredicate(Map<Holder<DamageType>, MinMaxBounds.Ints> damages, Optional<Holder<DamageType>> last) implements EntitySubPredicate {

  public static final MapCodec<DamageTrackerPredicate> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(Codec.unboundedMap(DamageType.CODEC, MinMaxBounds.Ints.CODEC).fieldOf("damages").forGetter(DamageTrackerPredicate::damages),
