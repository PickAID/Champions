...
public final class ChampionsBuiltInRegistries {
	...
	public static final Registry<MapCodec<? extends ChampionMobPropertyProvider>> CHAMPION_PROPERTY_PROVIDER_TYPE = register(ChampionsRegistries.CHAMPION_MOB_PROPERTY_PROVIDER_TYPE);
