...
public final class ChampionsTheOneProbePlugin implements Function<ITheOneProbe, Void> {
  public static final ResourceLocation ELEMENT_STAR = ChampionsUtil.id("element_star");
  public static final ResourceLocation ELEMENT_COLORED_TEXT = ChampionsUtil.id("element_colored_text");
  public static final ResourceLocation PROVIDER_CHAMPION_PROPERTY = ChampionsUtil.id("provider_champion_property");
  public static final ResourceLocation PROVIDER_ENTITY_AFFIXES = ChampionsUtil.id("provider_entity_affixes");
