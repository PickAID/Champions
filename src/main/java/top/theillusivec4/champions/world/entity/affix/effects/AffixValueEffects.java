...
public final class AffixValueEffects {
  private static final DeferredRegister<MapCodec<? extends AffixValueEffect>> DEFERRED_REGISTER = DeferredRegister.create(ChampionsRegistries.AFFIX_VALUE_EFFECT_TYPE, Champions.MOD_ID);
