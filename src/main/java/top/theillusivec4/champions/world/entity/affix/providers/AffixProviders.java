...
public final class AffixProviders {
  private static final DeferredRegister<MapCodec<? extends AffixProvider>> DEFERRED_REGISTER = DeferredRegister.create(ChampionsRegistries.AFFIX_PROVIDER_TYPE, Champions.MOD_ID);
