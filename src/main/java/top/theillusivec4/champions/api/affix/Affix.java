...
public record Affix(
  ...
  private static <T> void applyConditionalEffects(List<ConditionalEffect<T>> effects, LootContext context, Consumer<T> consumer) {
  ...
  public record AffixDefinition(
    ...
    public static class Builder {
      ...
      private Cost minCost = null;
      private Cost maxCost = null;
      ...
      public Builder supportedEntityTypes(@Nullable HolderSet<EntityType<?>> supportedEntityTypes) {
      ...
      public AffixDefinition build() {
        return new AffixDefinition(
          ...
          maxLevel,
          weight,
          minCost != null ? minCost : dynamicCost(3, 5),
          maxCost != null ? maxCost : dynamicCost(5, 5)
        );
      }
    }
  }
