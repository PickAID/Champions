...
public final class Attachments {
  ...
  public static final Supplier<AttachmentType<Optional<TextColor>>> COLOR = register("color", AttachmentType.<Optional<TextColor>>builder(Optional::empty).serialize(TextColor.CODEC.optionalFieldOf("color")).sync(ByteBufCodecs.fromCodec(TextColor.CODEC).apply(ByteBufCodecs::optional)));
