...
public class ParalyzingAffix extends CombatAffix {
  ...
  public boolean onAttack(
    ...
    if (target.getRandom().nextFloat() < ChampionsConfig.paralyzingChance && !target.hasEffect(MobEffects.PARALYSIS)) {
      target.addEffect(new MobEffectInstance(MobEffects.PARALYSIS, 60, 0));
    }
    return true;
  }
