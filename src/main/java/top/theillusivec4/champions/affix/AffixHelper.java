...
public final class AffixHelper {
  ...
  public static AffixContainer get(Entity entity) {
    return entity.getExistingData(ChampionsAttachments.AFFIX_CONTAINER).orElse(AffixContainer.EMPTY);
  }

  public static void update(Entity entity, Consumer<AffixContainer.Mutable> consumer) {
    AffixContainer.Mutable mutable = get(entity).mutable();
    consumer.accept(mutable);
    set(entity, mutable.toImmutable());
  }

  public static void set(Entity entity, AffixContainer container) {
    entity.setData(ChampionsAttachments.AFFIX_CONTAINER, container);
  }
