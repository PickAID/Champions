...
public final class AffixValueEffectDocs {
  public static void assignType(ScriptDump scriptDump) {
    ProbeJSUtil.assignType(scriptDump, AffixValueEffect.class, context -> {
      ...
      context.dispatch("all_of", builder -> builder.member("effects", Types.type(AffixValueEffect.class).asArray()));
