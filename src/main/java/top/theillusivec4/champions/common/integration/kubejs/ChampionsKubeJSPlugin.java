...
public class ChampionsKubeJSPlugin extends KubeJSPlugin {
	public static final RegistryInfo<CustomAffix> CUSTOM_AFFIX = RegistryInfo.of(AffixRegistry.AFFIX_REGISTRY_KEY, CustomAffix.class);

	@Override
	public void registerEvents() {
		CUSTOM_AFFIX.addType("affix", CustomAffix.Builder.class, CustomAffix.Builder::new, true);
		EventHandlers.ChampionsJs.register();
	}
