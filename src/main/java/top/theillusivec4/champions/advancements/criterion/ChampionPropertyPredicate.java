...
public record ChampionPropertyPredicate(Optional<net.minecraft.advancements.criterion.MinMaxBounds.Ints> tier, Optional<TextColor> color, Optional<Component> prefix, Optional<Boolean> boss) implements EntitySubPredicate {
