...
public final class Attachments {
	...
	// Champion Common
	public static final Supplier<AttachmentType<Optional<Affixes>>> AFFIXES = register("affixes", AttachmentType.<Optional<Affixes>>builder(Optional::empty).serialize(Affixes.CODEC.optionalFieldOf("affixes")).sync(Affixes.STREAM_CODEC.apply(ByteBufCodecs::optional)));
