...
public final class AffixEffectComponents {
  ...
  public static final Supplier<DataComponentType<List<ConditionalEffect<DamageImmunity>>>> DAMAGE_IMMUNITY = register("damage_immunity", builder -> builder.persistent(ConditionalEffect.validatedListCodec(DamageImmunity.CODEC, LootContextParamSets.DAMAGE_PROTECTION)));
  public static final Supplier<DataComponentType<List<ConditionalEffect<AffixValueEffect>>>> KNOCKBACK = register("knockback", builder -> builder.persistent(ConditionalEffect.validatedListCodec(AffixValueEffect.CODEC, LootContextParamSets.KNOCKBACK)));
  public static final Supplier<DataComponentType<List<ConditionalEffect<AffixValueEffect>>>> DAMAGE = register("damage", builder -> builder.persistent(ConditionalEffect.validatedListCodec(AffixValueEffect.CODEC, LootContextParamSets.DAMAGE)));
