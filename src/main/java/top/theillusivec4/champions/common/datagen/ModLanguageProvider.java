...
public class ModLanguageProvider extends LanguageProvider {
	...
	public ModLanguageProvider(DataGenerator gen, String locale) {
		this(gen, Champions.MODID, locale);
	}
	...
	private void addBrazilianPortugueseTranslations() {
		...
		// Damage Type
		addDamageSource(ModDamageSources.ENKINDLING_BULLET, "%1$s foi atingido por chamas", "%1$s foi atingido por chamas enquanto lutava contra %2$s");
		addDamageSource(ModDamageSources.REFLECTION_DAMAGE, "%1$s provou do próprio veneno", "");
	...
	private void addUkrainianTranslations() {
		...
		// Damage Type
		addDamageSource(ModDamageSources.ENKINDLING_BULLET, "%1$s був охоплений полум'ям", "%1$s був охоплений полум'ям під час бою %2$s");
		addDamageSource(ModDamageSources.REFLECTION_DAMAGE, "%1$s відчули смак власних ліків", "");
		// Dynamic Command Exception Type
	...
	protected void addChineseTranslations() {
		...
		// 伤害类型
		addDamageSource(ModDamageSources.ENKINDLING_BULLET, "%1$s被火焰击中", "%1$s在与%2$s的战斗中被火焰击中");
		addDamageSource(ModDamageSources.REFLECTION_DAMAGE, "%1$s遭报应了!", "");
		// 动态命令异常类型
	...
	protected void addEnglishTranslations() {
		...
		// Damage Type
		addDamageSource(ModDamageSources.ENKINDLING_BULLET, "%1$s was struck by flames", "%1$s was struck by flames whilst fighting %2$s");
		addDamageSource(ModDamageSources.REFLECTION_DAMAGE, "%1$s got a taste of their own medicine", "");
		// Dynamic Command Exception Type
	...
	protected void addTurkishTranslations() {
		...
		// Damage Type
		addDamageSource(ModDamageSources.ENKINDLING_BULLET, "%1$s yandı", "%1$s ,  %2$s ile savaşırken yandı.");
		addDamageSource(ModDamageSources.REFLECTION_DAMAGE, "%1$s kendi ilacının tadına baktı", "");
		// Dynamic Command Exception Type
	...
	protected void addRussianTranslations() {
		...
		// Damage Type
		addDamageSource(ModDamageSources.ENKINDLING_BULLET, "%1$s was struck by flames", "%1$s was struck by flames whilst fighting %2$s");
		addDamageSource(ModDamageSources.REFLECTION_DAMAGE, "%1$s попробовал на вкус собственное лекарство", "");
		// Dynamic Command Exception Type
		add("argument.champions.affix.unknown", "Unknown affix %s");
		// Command
	...
	protected void addKoreaTranslations() {
		...
		// Damage Type
		addDamageSource(ModDamageSources.ENKINDLING_BULLET, "%1$s은(는) 불타올랐습니다", "%1$s은(는) %2$s과(와) 싸우다가 불타올랐습니다");
		addDamageSource(ModDamageSources.REFLECTION_DAMAGE, "%1$s은(는) 자기 꾀에 자기가 넘어갔습니다", "");
		// Dynamic Command Exception Type
	 ...
	 *
	 * @param damageSource        damage type Object
	 * @param translate         death message translation
	 * @param byPlayerTranslate player killed by the player death message translation
	 */
	protected void addDamageSource(String damageSource, String translate, String byPlayerTranslate) {
		add("death.attack." + damageSource, translate);
		add("death.attack." + damageSource + ".player", byPlayerTranslate);
	}
