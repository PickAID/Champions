            ...
            ChampionCapability.getCapability(entity).ifPresent(champion -> {
                ...
                if (ChampionsConfig.lootSource != ConfigEnums.LootSource.CONFIG) {
                    LootTable lootTable = serverWorld.getServer().getLootTables()
                            .get(ModLootModifiers.CHAMPION_LOOT.getId());
                    LootContext.Builder lootParamsBuilder = new LootContext.Builder(serverWorld)
                    ...
                    LootContext lootParams = lootParamsBuilder.create(LootContextParamSets.ENTITY);
                    lootTable.getRandomItemsRaw(lootParams, generatedLoot::add);
                }
