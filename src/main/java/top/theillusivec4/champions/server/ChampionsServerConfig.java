...
public final class ChampionsServerConfig {
  ...
  public static final ModConfigSpec.DoubleValue RANDOM_VARIATION_FACTOR;
  ...
  static {
    ...
    RANDOM_VARIATION_FACTOR = builder.defineInRange("random_variration_factor", 0.15, 0.0, 1.0);
