...
public final class ChampionsAttachments {
  ...
  public static final Supplier<AttachmentType<EntityAffixes>> ENTITY_AFFIXES = register("entity_affixes", AttachmentType.builder(() -> EntityAffixes.EMPTY).serialize(EntityAffixes.MAP_CODEC.codec()).sync(EntityAffixes.STREAM_CODEC));
  ...
  public static final Supplier<AttachmentType<ChampionMobProperty>> CHAMPION_MOB_PROPERTY = register("champion_mob_property", AttachmentType.builder(() -> ChampionMobProperty.EMPTY).serialize(ChampionMobProperty.MAP_CODEC.codec()).sync(ChampionMobProperty.STREAM_CODEC));
