...
public class ModLootItemConditions {
  ...
  public static final DeferredHolder<LootItemConditionType, LootItemConditionType> CHAMPION_PROPERTIES = LOOT_ITEM_CONDITION_TYPE.register("champion_properties", () -> new LootItemConditionType(ChampionPropertyCondition.MAP_CODEC));
