package top.theillusivec4.champions.core.components;
...
public class ChampionsDataComponents {
	private static final DeferredRegister<DataComponentType<?>> DEFERRED_REGISTER = DeferredRegister.createDataComponents(Registries.DATA_COMPONENT_TYPE, Champions.MOD_ID);
