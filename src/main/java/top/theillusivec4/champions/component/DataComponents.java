...
public class DataComponents {
  ...
  @Deprecated
  public static final DeferredHolder<DataComponentType<?>, DataComponentType<Boolean>> VALID = register("valid", DataComponentType.<Boolean>builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL));
  ...
  public static final DeferredHolder<DataComponentType<?>, DataComponentType<Boolean>> BOSS = register("boss", DataComponentType.<Boolean>builder().persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL));
